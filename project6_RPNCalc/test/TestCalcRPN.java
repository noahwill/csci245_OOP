...
public class TestCalcRPN extends TestCalcAbs {
    ...
    @Test
    public void operatorMash() {
        testSequence("**1.--2.++3.//4**", new String[] {"4"});
    }
    
    @Test
    public void isItTheSame() {
        testSequence("9.***", new String[] {"9"});
    }
    
    @Test
    public void longStack() {
        testSequence("1.2.3.4.5.6.7.8.10.12.+-*/+-*/-", new String[] {"24"});
    }
}
